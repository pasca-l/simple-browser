...
// lexer is equivalent to a tokenizer with additional function
// however the implementation will only include functions for tokenizer
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct JsLexer {
    pos: usize,
    input: Vec<char>,
...
impl JsLexer {
    ...
    // checks for any reserved keywords
