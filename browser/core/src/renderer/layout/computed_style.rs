...
// CSS properties are calculated as values in the following order:
// 1. declared values
// 2. cascaded values
// 3. specified values
// 4. computed values <- ComputedStyle struct will handle this
// 5. used values
// 6. actual values
...
impl ComputedStyle {
    ...
    pub fn defaulting(&mut self, node: &Rc<RefCell<Node>>, parent_style: Option<ComputedStyle>) {
        // inherit property from the parent
        ...
        // initial values for each properties
