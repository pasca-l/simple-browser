...
impl LayoutObject {
    fn new(node: Rc<RefCell<Node>>, parent_obj: &Option<Rc<RefCell<LayoutObject>>>) -> Self {
    ...
    pub fn compute_position(
        ...
        match (self.kind(), previous_sibiling_kind) {
            // block elements grow along the y-axis
            ...
            // inline elements grow along the x-axis
...
pub enum LayoutObjectKind {
    Block,
    Inline,
    // text is actually also an inline element,
    // but the text kind is introduced for implementation simplicity
    Text,
}
